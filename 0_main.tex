...
\input{4_Metode/1_GraphsAndNetworks}
\input{4_Metode/2_LatentSpaceModels}
\input{4_Metode/3_PoissonProcess}
\input{4_Metode/4_IntensityFunction}
\input{4_Metode/5_LikelihoodFunction}
\input{4_Metode/6_ProposedModel}
\input{4_Metode/7_Scalability}
\input{4_Metode/8_PossionPointProcessSimulation}
\input{4_Metode/9_Implementation}
\input{4_Metode/10_ResultsEvaluation}
\clearpage
...
\input{5_Results/0_reproducibility}
\input{5_Results/Q1}
\clearpage
\input{5_Results/Q2}
\clearpage
...
\input{6_Discussion/1_ResultsDiscussion}
\input{6_Discussion/2_FutureWork}
\input{6_Discussion/3_RealWorldApplications}
\clearpage
